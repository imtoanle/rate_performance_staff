...
class DepartmentTableSeeder extends Seeder {
  ...
  public function run()
  {
    ...
    Department::create(array('name' => 'Thư ký'));
    Department::create(array('name' => 'Dệt may'));
    Department::create(array('name' => 'Thuốc lá'));
    Department::create(array('name' => 'Tổ chức hành chính'));
    Department::create(array('name' => 'Tài vụ'));
