...
return array(
    'user' => array(
        ...
        'register' => array(
                ...
                'pass' => array('required', 'min:6', 'max:255'),
                'username' => array('required', 'min:3', 'max:255', 'alpha', 'unique:users'),
                'name' => array('required', 'min:3', 'max:255'),
            ),
    ),
    'group' => array(
    ...
    'imei-service-group' => array(
        'create' => array(
            'group_name' => array('required', 'min:3', 'max:100')
        )
    ),
    'admincp' => array(
        'imei-service-create' => array(
            'service_name' => array('required')
        ),
        'imei-service-group-create' => array(
                'group_name' => array('required', 'min:3', 'max:100')
        ),
    ),
);