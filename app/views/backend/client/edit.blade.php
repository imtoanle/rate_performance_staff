			...
			<div class="row">
				<div class="col-md-3">
						<div class="tile-stats tile-aqua">
							...
							<div class="num" data-start="0" data-end="{{$client->amount}}" data-prefix="$ " data-duration="500" data-delay="0">$ {{round($client->amount)}}</div>
						</div>
					</div>
					<div class="col-md-3">
						...
						<div class="row">
							...
							<div class="col-md-offset-3 col-sm-9">
								...
								<ul class="user-details">
									...
									<li><a><i class="entypo-location"></i>{{$client->address}}</a></li>
