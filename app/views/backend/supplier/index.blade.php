...
@section('content')
<form id="datatable-form" action-delete="{{route('deleteSupplier')}}"> 
...
<a href="{{route('newSupplier')}}" class="btn btn-primary btn-icon icon-left">
...
jQuery(window).load(function()
{
	...
	tableData  = $("table.datatable").dataTable({
		...
		"iDisplayLength": 10,
		"bServerSide": true,
    "sAjaxSource": "<?php echo URL::route('indexSupplier') ?>",
    "sServerMethod": "POST",
		"aoColumns": [
