    ...
    <ul class="nav navbar-nav pull-right">
      ...
      <li class="dropdown" id="header_notification_bar">
        ...
        <ul class="dropdown-menu extended notification">
          ...
          <li class="external">
            <a href="index.html#">See all notifications <i class="fa fa-angle-right"></i></a>
          </li>
        </ul>
      </li>
      ...
      <li class="dropdown" id="header_inbox_bar">
        ...
        <ul class="dropdown-menu extended inbox">
          ...
          <li>
            <ul class="dropdown-menu-list scroller" style="height: 250px;">
              <li>
                <a href="http://www.keenthemes.com/preview/conquer/inbox.html?a=view">
                <span class="photo">
          ...
          <li class="external">
            <a href="http://www.keenthemes.com/preview/conquer/inbox.html">See all messages <i class="fa fa-angle-right"></i></a>
          </li>
        </ul>
      </li>
      <!-- END INBOX DROPDOWN -->
      ...
      <li class="dropdown" id="header_task_bar">
        ...
        <ul class="dropdown-menu extended tasks">
          ...
          <li class="external">
            <a href="index.html#">See all tasks <i class="fa fa-angle-right"></i></a>
          </li>
        </ul>
      </li>
      <!-- END TODO DROPDOWN -->
      ...
      <li class="dropdown user">
        ...
        <ul class="dropdown-menu">
          <li>
            <a href="http://www.keenthemes.com/preview/conquer/extra_profile.html"><i class="fa fa-user"></i> My Profile</a>
          </li>
          <li>
            <a href="page_calendar.html"><i class="fa fa-calendar"></i> My Calendar</a>
          </li>
          <li>
            <a href="http://www.keenthemes.com/preview/conquer/inbox.html"><i class="fa fa-envelope"></i> My Inbox
          ...
          <li>
            <a href="index.html#"><i class="fa fa-tasks"></i> My Tasks
            <span class="badge badge-success">
               7
            </span>
            </a>
