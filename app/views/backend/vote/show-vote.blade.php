...
<div class="portlet">
  <div class="portlet-title">
    <div class="caption">
      <i class="fa fa-reorder"></i>{{trans('all.edit-vote')}}
    </div>
    <div class="tools">
  ...
  <div class="portlet-body form">
    <!-- BEGIN FORM-->
    <form action="{{route('putVote', $vote->id)}}" class="horizontal-form base-ajax-form" type="PUT">
      <div class="form-body">
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="form-group">
              ...
              <input type="text" name="title" class="form-control" value="{{$vote->title}}" placeholder="VD: Đánh giá nhân viên tháng xx">
            </div>
          </div>
          <!--/span-->
          <div class="col-md-7">
            <div class="form-group">
              ...
              <input type="hidden" name="select2_entitled_vote" id="select2_entitled_vote" value="{{$vote->entitled_vote}}" class="form-control select2" multiple>
            </div>
          </div>
          <!--/span-->
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group">
              ...
              <select id="select_groups" name="select2_groups" class="form-control select2" multiple>
                @foreach($groups as $group)
                  <option value="{{$group->id}}" {{in_array($group->id, explode(',',$vote->object_entitled_vote)) ? 'selected' : ''}}>{{$group->name}}</option>
                @endforeach
              </select>
            </div>
          </div>
          ...
          <div class="col-md-7">
            <div class="form-group">
              ...
              <input type="hidden" name="select2_voter" id="select2_voter" value="{{$vote->voter}}" class="form-control select2" multiple>
            </div>
          </div>
          <!--/span-->
        </div>
